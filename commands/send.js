...
module.exports = {
    ...
    action: function(args, callback) {
        ...
        rimraf.sync('./tmp');
        this.db.all('SELECT * FROM applicants WHERE tag=$tag', {$tag: args.tag}, (err, rows) => {
            if(rows.length === 0 && args.tag) {
                ...
                console.log('you need to choose a unique tag for this test');
                callback();
            }
        });
    }
